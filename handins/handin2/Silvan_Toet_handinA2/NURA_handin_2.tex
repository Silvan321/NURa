...
\begin{equation}
  \iiint_V f(r,\theta,\phi)\, r^2 \sin\theta \, dr\,d\theta\,d\phi = \int_{\phi=0}^{2\pi} \int_{\theta=0}^{\pi} \int_{r=0}^{r_{max}}
\end{equation}
Since n(x) where x is the radius relative to virial radius x=r/rvir is only dependent on r, we get
\begin{equation}
  \iiint_V n(x)\, r^2 \sin\theta \, dr\,d\theta\,d\phi =
\end{equation}
